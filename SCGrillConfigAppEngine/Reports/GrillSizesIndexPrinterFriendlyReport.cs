...
{
    class GrillSizesIndexPrinterFriendlyReport
    {
        public static void Generate(Report report, string fileSaveDirectory, Application app)
        {
            ...
            {
                string message = AppCommon.AppendInnerExceptionMessages("GrillSizesIndexViewReport.Generate: " + e.Message, e);
        ...
        private static void AddDocumentHeader(Document document)
        {
            ...
            paragraph.Range.Text = "GrillSizes";
        ...
        private static void AddDocumentBody(Document document)
        {
            ...
            List<GrillSize> grillSizes = new List<GrillSize>();
            grillSizes = Web_Data.GrillSizesWebData.GetGrillSizes();
            ...
            // add table data rows
            foreach (GrillSize grillSize in grillSizes)
            {
                table.Rows.Add();
                // format data row
                ...
                table.Rows[table.Rows.Count].Cells[1].Range.Text = grillSize.Name.ToString();
