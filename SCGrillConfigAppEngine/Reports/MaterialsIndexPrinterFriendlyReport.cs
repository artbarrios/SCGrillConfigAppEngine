...
{
    class MaterialsIndexPrinterFriendlyReport
    {
        public static void Generate(Report report, string fileSaveDirectory, Application app)
        {
            ...
            {
                string message = AppCommon.AppendInnerExceptionMessages("MaterialsIndexViewReport.Generate: " + e.Message, e);
        ...
        private static void AddDocumentHeader(Document document)
        {
            ...
            paragraph.Range.Text = "Materials";
        ...
        private static void AddDocumentBody(Document document)
        {
            ...
            materials = Web_Data.MaterialsWebData.GetMaterials();
            ...
            foreach (Material material in materials)
            {
                ...
                table.Rows[table.Rows.Count].Cells[1].Range.Text = material.Name.ToString();
