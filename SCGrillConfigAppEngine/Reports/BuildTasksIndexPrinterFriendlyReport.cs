...
{
    class BuildTasksIndexPrinterFriendlyReport
    {
        public static void Generate(Report report, string fileSaveDirectory, Application app)
        {
            ...
            {
                string message = AppCommon.AppendInnerExceptionMessages("BuildTasksIndexViewReport.Generate: " + e.Message, e);
        ...
        private static void AddDocumentHeader(Document document)
        {
            ...
            paragraph.Range.Text = "BuildTasks";
        ...
        private static void AddDocumentBody(Document document)
        {
            ...
            buildTasks = Web_Data.BuildTasksWebData.GetBuildTasks();
            ...
            table.Rows[table.Rows.Count].Cells[2].Range.Text = "Notes";
            ...
            foreach (BuildTask buildTask in buildTasks)
            {
                ...
                table.Rows[table.Rows.Count].Cells[1].Range.Text = buildTask.Name.ToString();
                table.Rows[table.Rows.Count].Cells[2].Range.Text = buildTask.Notes.ToString();
