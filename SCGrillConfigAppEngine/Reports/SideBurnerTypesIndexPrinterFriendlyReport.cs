...
{
    class SideBurnerTypesIndexPrinterFriendlyReport
    {
        public static void Generate(Report report, string fileSaveDirectory, Application app)
        {
            ...
            {
                string message = AppCommon.AppendInnerExceptionMessages("SideBurnerTypesIndexViewReport.Generate: " + e.Message, e);
        ...
        private static void AddDocumentHeader(Document document)
        {
            ...
            paragraph.Range.Text = "SideBurnerTypes";
        ...
        private static void AddDocumentBody(Document document)
        {
            ...
            List<SideBurnerType> sideBurnerTypes = new List<SideBurnerType>();
            sideBurnerTypes = Web_Data.SideBurnerTypesWebData.GetSideBurnerTypes();
            ...
            // add table data rows
            foreach (SideBurnerType sideBurnerType in sideBurnerTypes)
            {
                table.Rows.Add();
                // format data row
                ...
                table.Rows[table.Rows.Count].Cells[1].Range.Text = sideBurnerType.Name.ToString();
