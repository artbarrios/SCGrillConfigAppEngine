...
{
    class FuelsIndexPrinterFriendlyReport
    {
        public static void Generate(Report report, string fileSaveDirectory, Application app)
        {
            ...
            {
                string message = AppCommon.AppendInnerExceptionMessages("FuelsIndexViewReport.Generate: " + e.Message, e);
        ...
        private static void AddDocumentBody(Document document)
        {
            ...
            fuels = Web_Data.FuelsWebData.GetFuels();
            ...
            foreach (Fuel fuel in fuels)
            {
                ...
                table.Rows[table.Rows.Count].Cells[1].Range.Text = fuel.Name.ToString();
