...
{
    class GrillTypesIndexPrinterFriendlyReport
    {
        public static void Generate(Report report, string fileSaveDirectory, Application app)
        {
            ...
            {
                string message = AppCommon.AppendInnerExceptionMessages("GrillTypesIndexViewReport.Generate: " + e.Message, e);
        ...
        private static void AddDocumentHeader(Document document)
        {
            ...
            paragraph.Range.Text = "GrillTypes";
        ...
        private static void AddDocumentBody(Document document)
        {
            ...
            List<GrillType> grillTypes = new List<GrillType>();
            grillTypes = Web_Data.GrillTypesWebData.GetGrillTypes();
            ...
            // add table data rows
            foreach (GrillType grillType in grillTypes)
            {
                table.Rows.Add();
                // format data row
                ...
                table.Rows[table.Rows.Count].Cells[1].Range.Text = grillType.Name.ToString();
