...
{
    class ColorsIndexPrinterFriendlyReport
    {
        public static void Generate(Report report, string fileSaveDirectory, Application app)
        {
            ...
            {
                string message = AppCommon.AppendInnerExceptionMessages("ColorsIndexViewReport.Generate: " + e.Message, e);
        ...
        private static void AddDocumentBody(Document document)
        {
            ...
            colors = Web_Data.ColorsWebData.GetColors();
            ...
            foreach (Color color in colors)
            {
                ...
                table.Rows[table.Rows.Count].Cells[1].Range.Text = color.Name.ToString();
